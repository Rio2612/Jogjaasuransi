  ...
  return (
    <section id="testimonial" className="py-[5.5rem] px-[5vw] bg-white">
      <div className="text-center mb-12">
        <div className="text-xs font-bold tracking-[2.5px] uppercase text-goldtext mb-2">Testimoni Klien</div>
        <h2 className="font-heading text-[clamp(1.9rem,3vw,2.9rem)] leading-[1.22] text-navy">Apa Kata Mereka?</h2>
        <p className="text-[0.95rem] leading-[1.8] text-[#475569] max-w-[560px] mx-auto mt-3">Kepercayaan klien adalah motivasi terbesar kami untuk terus memberikan pelayanan yang terbaik.</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {TESTIMONI.map(t => (
          <div key={t.nama} className="bg-cream rounded-card p-7 border border-black/5">
            <div className="text-goldtext text-[1rem] mb-3">★★★★★</div>
            <p className="text-[1rem] leading-[1.75] text-[#475569] italic mb-4">&ldquo;{t.teks}&rdquo;</p>
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="text-xs text-[#475569]">{t.peran}</div>
              </div>
            </div>
          </div>
        ))}
