    ...
    <footer className="bg-[#071422] px-[5vw] pt-12 pb-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 pb-8 border-b border-white/7">
        <div>
          ...
          <p className="text-sm leading-[1.75] text-white/60">Praktisi asuransi kerugian independen di Yogyakarta. Melayani individu, UMKM, dan korporasi dengan solusi perlindungan yang tepat, transparan, dan dapat diandalkan.</p>
        </div>
        <div>
