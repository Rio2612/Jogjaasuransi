...
export default function Kalkulator() {
  ...
  return (
    <section id="kalkulator" className="py-[5.5rem] px-[5vw] bg-navy">
      ...
      <div className="bg-white/4 border border-gold/20 rounded-[20px] p-10 max-w-[700px] mx-auto">
        {/* Row 1 */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="flex flex-col gap-1.5">
            <label className="text-[0.82rem] font-semibold text-white/75">Plat Kendaraan (Asal Daerah)</label>
            <select
              className="bg-white/7 border border-white/15 text-white px-3.5 py-[11px] rounded-lg text-[0.88rem] outline-none focus:border-gold appearance-none"
              onChange={e => {
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select className="bg-white/7 border border-white/15 text-white px-3.5 py-[11px] rounded-lg text-[0.88rem] outline-none focus:border-gold appearance-none" value={jenis} onChange={e => setJenis(e.target.value as JenisKendaraan)}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
          <div className="flex flex-col gap-1.5">
            ...
            <select className="bg-white/7 border border-white/15 text-white px-3.5 py-[11px] rounded-lg text-[0.88rem] outline-none focus:border-gold appearance-none" value={tipe} onChange={e => setTipe(e.target.value as TipePerlindungan)}>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select className="bg-white/7 border border-white/15 text-white px-3.5 py-[11px] rounded-lg text-[0.88rem] outline-none focus:border-gold appearance-none" value={periode} onChange={e => setPeriode(Number(e.target.value))}>
        ...
        <div className="mt-5">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="bg-white/7 border border-white/15 text-white px-3.5 py-[11px] rounded-lg text-[0.88rem] outline-none focus:border-gold placeholder-white/30"
            />
