      ...
      <div className="bg-white/5 border border-gold/20 rounded-[20px] p-10 max-w-[700px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="flex flex-col gap-1.5">
            <label className="text-[0.95rem] font-semibold text-white/75">Plat Kendaraan (Asal Daerah)</label>
            <select
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[0.95rem] font-semibold text-white/75">Jenis Kendaraan</label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
          <div className="flex flex-col gap-1.5">
            <label className="text-[0.95rem] font-semibold text-white/75">Jenis Perlindungan</label>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-[0.95rem] font-semibold text-white/75">Periode Asuransi</label>
        ...
        <div className="mt-5">
          <div className="flex flex-col gap-1.5">
            <label className="text-[0.95rem] font-semibold text-white/75">Harga Kendaraan (Rp)</label>
            <input
              type="number"
          ...
          <div className="mt-6 bg-gold/10 border border-gold/30 rounded-xl p-6">
            ...
            <div className="flex flex-col gap-2.5">
              {[
                ...
                <div key={row.label} className="flex justify-between items-center text-[1rem]">
            ...
            <a href={`https://wa.me/${KONTAK.wa}?text=${hasil.waMsg}`} className="block text-center mt-4 bg-[#25D366] text-white py-3 rounded-lg font-bold text-[1rem] no-underline hover:opacity-90 transition-opacity">
