    ...
    <>
      ...
      <article className="max-w-[760px] mx-auto px-[5vw] py-14">
        ...
        <div className="bg-navy rounded-[20px] p-8 text-center">
          ...
          <p className="text-white/65 text-sm mb-6 max-w-[400px] mx-auto">Konsultasikan dengan Pak Rio — kami bisa merekomendasikan bengkel rekanan terbaik sesuai merek dan jenis kendaraan Anda di Yogyakarta.</p>
