...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "id_ID",
    type: "website",
    images: [{ url: "/og/og-liability.png", width: 1200, height: 630, alt: "Asuransi Public Liability Jogja – Hotel, Restoran & Wisata" }],
  },
};
    ...
    <LiabilityLayout breadcrumbs={[
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-3xl mx-auto">
          {yangDijamin.map(y=>(
            <div key={y.label} className="bg-white rounded-card p-6 border border-black/6 hover:-translate-y-1 transition-all">
              ...
              <p className="text-base leading-relaxed text-[#475569]">{y.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="skenario" className="py-16 px-[5vw] bg-white">
        <div className="text-center mb-10">
          ...
          <p className="text-base text-[#475569] max-w-[480px] mx-auto mt-3">Semua skenario ini adalah kejadian riil yang telah menyebabkan gugatan hukum terhadap pelaku usaha di Indonesia</p>
        </div>
      ...
      <section className="py-20 px-[5vw] bg-navy text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-sm max-w-[460px] mx-auto mb-8">Konsultasi gratis analisis risiko Public Liability untuk bisnis Anda di Yogyakarta. Kami bantu tentukan limit yang tepat.</p>
