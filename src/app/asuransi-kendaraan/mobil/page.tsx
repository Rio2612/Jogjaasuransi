...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "id_ID",
    type: "website",
    images: [{ url: "/og/og-kendaraan.png", width: 1200, height: 630, alt: "Asuransi Mobil Jogja – All Risk & TLO, Mobil Listrik" }],
  },
};
    ...
    <KendaraanLayout breadcrumbs={[
      ...
      <section className="py-20 px-[5vw] bg-navy text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-sm max-w-[460px] mx-auto mb-8">Dapatkan penawaran terbaik dari berbagai perusahaan asuransi — gratis, transparan, tanpa tekanan.</p>
