...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/artikel/perbedaan-car-ear-asuransi-engineering`,  lastModified: now, changeFrequency: "monthly", priority: 0.90 },
    { url: `${base}/artikel/premi-asuransi-car-jogja`,                lastModified: now, changeFrequency: "monthly", priority: 0.90 },
    { url: `${base}/artikel/asuransi-mesin-pabrik-jogja`,             lastModified: now, changeFrequency: "monthly", priority: 0.88 },
    { url: `${base}/artikel/asuransi-kontraktor-proyek-jogja`,        lastModified: now, changeFrequency: "monthly", priority: 0.90 },
    ...
    { url: `${base}/artikel/cara-klaim-asuransi-mobil`,               lastModified: now, changeFrequency: "monthly", priority: 0.83 },
    { url: `${base}/artikel/cara-menghitung-premi-asuransi-mobil`,    lastModified: now, changeFrequency: "monthly", priority: 0.80 },
    ...
    { url: `${base}/artikel/bengkel-rekanan-asuransi-jogja`,          lastModified: now, changeFrequency: "monthly", priority: 0.72 },
    { url: `${base}/artikel/pentingnya-asuransi-dunia-usaha-jogja`,   lastModified: now, changeFrequency: "monthly", priority: 0.72 },
