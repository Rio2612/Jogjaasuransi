    ...
    <KargoLayout breadcrumbs={[
        ...
        <div className="flex flex-col gap-4 max-w-3xl mx-auto">
          {jalurUnggulan.map(j=>(
            <div key={j.rute} className="bg-white rounded-card p-5 border border-black/6 grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_1fr] gap-3 items-center">
              ...
              <div className="text-xs text-[#475569]"><span className="font-semibold text-navy">Moda:</span> {j.moda}<br /><span className="font-semibold text-navy">Estimasi:</span> {j.waktu}</div>
      ...
      <section className="py-20 px-[5vw] bg-navy text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-sm max-w-[460px] mx-auto mb-8">Urus asuransi marine cargo dan air freight bersama praktisi berpengalaman. Konsultasi gratis, premi kompetitif.</p>
