    ...
    <EngineeringLayout breadcrumbs={[
      ...
      <section className="py-20 px-[5vw] bg-navy text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-sm max-w-[460px] mx-auto mb-8">Konsultasi gratis Machinery Breakdown — kami bantu inventarisir mesin, hitung nilai pertanggungan, dan pilih polis yang tepat untuk industri Anda.</p>
