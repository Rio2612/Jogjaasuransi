    ...
    <PropertyLayout breadcrumbs={[
      ...
      <section className="py-20 px-[5vw] bg-navy text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-sm max-w-[460px] mx-auto mb-8">Konsultasi gratis, analisis risiko, penawaran terbaik dari asuransi terpercaya — tanpa biaya apapun.</p>
